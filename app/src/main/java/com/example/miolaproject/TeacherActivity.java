...
public class TeacherActivity extends AppCompatActivity {
    ...
    private StudentRvAdapter teacherRvAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teacherRV = findViewById(R.id.idRVteacher);
        ...
        teacherRvAdapter = new StudentRvAdapter(teacherArrayList, this);
        // setting adapter to our recycler view.
        teacherRV.setAdapter(teacherRvAdapter);
        // below line is use to get the data from Firebase Firestore.
        // previously we were saving data on a reference of Users
        // now we will be getting the data from the same reference.
        db.collection("Users") .whereEqualTo("role", "Teacher").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                if (!queryDocumentSnapshots.isEmpty()) {
                    ...
                    Toast.makeText(TeacherActivity.this, "No data found in Database", Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(TeacherActivity.this, "Fail to get the data.", Toast.LENGTH_LONG).show();
